...
function NavList({ loged, logOut, admin, product }) {
  return (
    <ul className=" my-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      {loged ? (
        ...
        <Typography
          ...
          variant="small"
          color="blue-gray"
          className="focus:text-blue-500 p-1 font-medium flex items-center hover:text-blue-500 transition-colors"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
      ...
      {admin ? (
        ...
        <Typography
          ...
          className="focus:text-blue-500 p-1 font-medium flex items-center hover:text-blue-500 transition-colors"
        >
          <Badge content={product > 0 ? product : ""} className="size-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
...
const Nav = ({ loged, logOut, admin, product }) => {
  ...
  return (
    <Navbar className=" sticky z-50 top-0 w-full px-6 py-3 rounded-none bg-gray-300 border-gray-300 shadow-none ">
      <div className="flex items-center justify-between text-blue-gray-900 ">
        <Typography
          color="black"
          className="font-semibold text-xl ml-2 flex items-baseline gap-1"
        >
          Male fashion
        ...
        <div className="flex gap-5">
          <Typography
            ...
            variant="h5"
            color="gray"
            className="focus:underline decoration-red-600 p-1 font-semibold flex items-center hover:text-gray-900 focus:text-gray-900 transition-colors "
          >
            Home
          </Typography>
      ...
      <Collapse open={openNav} product={product}>
        <NavList
          loged={loged}
          logOut={logOut}
          admin={admin}
